...
Info
----
This file contains the basic functionalities of the heat_pump class.
...
class heat_pump(VPPComponent):
    ...
    def __init__(self, identifier, timebase, heatpump_type = "Air", 
        ...
        # Call to super class
        super(heat_pump, self).__init__(timebase, environment, userProfile)
