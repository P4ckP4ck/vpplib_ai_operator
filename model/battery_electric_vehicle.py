...
Info
----
This file contains the basic functionalities of the battery_electric_vehicle class.
...
class battery_electric_vehicle(VPPComponent):
    ...
    def __init__(self, timebase, identifier, start = None, end = None, time_freq = "15 min", battery_max = 16, 
        ...
        # Call to super class
        super(battery_electric_vehicle, self).__init__(timebase=timebase, environment=environment, userProfile=userProfile)
    ...
    def charge_forecast(self, at_home, charge_flag, battery_charge):
        ...
        #Function to apply the load_degradation to the load profile
            ...
            charger = degraded_charging_power * self.timebase
