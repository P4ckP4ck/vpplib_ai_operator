...
Info
----
This file contains the basic functionalities of the electrical_energy_storage class.
...
class electrical_energy_storage(VPPComponent):
    ...
    def __init__(self, timebase, identifier, capacity, chargeEfficiency, dischargeEfficiency, maxPower, maxC, environment = None, userProfile = None):
        ...
        Info
        ----
        The class "electrical_energy_storage" adds functionality to implement an
        ...
        # Call to super class
        super(electrical_energy_storage, self).__init__(timebase, environment, userProfile)
    ...
    def forecast_discharge(self, energy, timebase, soc):
        ...
        # Check if charge exceeds capacity
        if soc - energy * (1 / self.dischargeEfficiency) < 0:
            energy = (self.capacity - soc) * (1 / self.dischargeEfficiency)


        # Update state of charge
        soc -= energy * (1 / self.dischargeEfficiency)
        return soc
